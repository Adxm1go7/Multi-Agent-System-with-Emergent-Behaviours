...
class OpinionDynamicsModel(Model):
    description = (
        "A model for simulating opinion convergence"
    )
    ...
    def __init__(self, scenario=None):
        ...
        model_reporters = {
            # Dictionary stores an array of opinions for all agents in the given model m
        ...
        OpinionAgent.create_agents(
            ...
            self.random.sample(self.grid.all_cells.cells,
                               k=scenario.initial_agents),
